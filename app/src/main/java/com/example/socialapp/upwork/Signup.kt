...
//                        onForgotPassword()
    ...
    // Rest of the code for location, gender, date of birth text fields
}
...
//            )
//        ) {
//            UpWorkPasswordCompo(label = "Password", password = "", onPasswordChanged = {})
//
//        }
//
//        Card(
    ...
    Row(
        ...
        Box(
            ...
            UpWorkOutlinedTextFieldCompo(
                ...
                onValueChanged = { },
                onLeadingIconClick = { /* Handle leading icon click for text field 1 */ },
                onTrailingIconClick = { /* Handle trailing icon click for text field 1 */ }
            )
        }
        ...
        Box(
            ...
            UpWorkOutlinedTextFieldCompo(
                ...
                value = "",
                leadingIcon = Icons.Default.Man3,
                trailingIcon = Icons.Default.ArrowDropDown,
                onValueChanged = { },
                onLeadingIconClick = { /* Handle leading icon click for text field 2 */ },
                onTrailingIconClick = { /* Handle trailing icon click for text field 2 */ }
            )
        }
    }
}
